...
pub fn prepare_bind_group(
    ...
    pipeline: Res<crate::buffers_setup::ComputePipeline>,
    gpu_images: Res<RenderAssets<Image>>,
    raytracer_image: Res<ComputeImage>,
    render_device: Res<RenderDevice>,
    //mut ev_buffer_update: EventReader<ComputeBufferUpdateEvent>,
...
impl ComputeBuffer {
    pub fn new<T>(binding: u32, vector: Vec<T>) -> Self where T: Pod {
        ComputeBuffer {
            binding,
...
impl Command for SendUpdateEvent {
    fn apply(self, world: &mut World) {
        world.send_event(ComputeBufferUpdateEvent);
    }
}
...
impl ComputeBuffers {
    ...
    pub fn set_value_at<T>(&mut self, binding: u32, new_value: Vec<T>, mut commands: Commands) where T: Pod {
